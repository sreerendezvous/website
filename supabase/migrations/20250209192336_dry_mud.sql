-- Create experiences for each creator
DO $$
DECLARE
...
BEGIN
    ...
    (
        ...
        'Join Maya on a journey of mindfulness and meditation.',
        ARRAY[
            '{"url": "https://images.unsplash.com/photo-1593811167562-9cef47bfc4d7", "type": "image", "order": 0}'::jsonb,
            '{"url": "https://images.unsplash.com/photo-1545205597-3d9d02c29597", "type": "image", "order": 1}'::jsonb
        ],
        true,
        0
    ),
    (
        james_id,
        'Capture the Moment',
        'Explore urban photography with James in the heart of Hong Kong.',
        ARRAY[
            '{"url": "https://images.unsplash.com/photo-1496442226666-8d4d0e62e6e9", "type": "image", "order": 0}'::jsonb,
            '{"url": "https://images.unsplash.com/photo-1520974735549-8e4e0c47a174", "type": "image", "order": 1}'::jsonb
        ],
        true,
        1
    ),
    (
        sofia_id,
        'Taste the World',
        'Create culinary magic with Chef Sofia''s fusion cooking experience.',
        ARRAY[
            '{"url": "https://images.unsplash.com/photo-1556910103-1c02745aae4d", "type": "image", "order": 0}'::jsonb,
            '{"url": "https://images.unsplash.com/photo-1551218372-8a26d077b09f", "type": "image", "order": 1}'::jsonb
        ],
        true,
        2
    );
