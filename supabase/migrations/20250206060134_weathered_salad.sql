...
-- Allow any authenticated user to upload profile images
...
-- Allow any authenticated user to update their own profile images
...
-- Allow any authenticated user to delete their own profile images
