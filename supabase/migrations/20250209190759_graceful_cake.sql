-- Create sample data with proper creator profile
DO $$
DECLARE
...
BEGIN
    ...
    IF sakura_id IS NULL THEN
        ...
        RETURNING id INTO sakura_id;
    END IF;

    -- Get or create creator profile
    SELECT id INTO creator_profile_id FROM public.creator_profiles WHERE user_id = sakura_id;
